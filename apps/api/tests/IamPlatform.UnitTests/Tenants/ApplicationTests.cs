...
using TenantApplication = IamPlatform.Domain.Tenants.Application;
using Xunit;
...
public sealed class ApplicationTests
{
    ...
    {
        var application = TenantApplication.Create("app-001", "tenant-001", "Admin Portal");
    ...
    {
        var act = () => TenantApplication.Create(invalidId, "tenant-001", "Admin Portal");
    ...
    {
        var act = () => TenantApplication.Create("app-001", invalidTenantId, "Admin Portal");
    ...
    {
        var act = () => TenantApplication.Create("app-001", "tenant-001", invalidName);
